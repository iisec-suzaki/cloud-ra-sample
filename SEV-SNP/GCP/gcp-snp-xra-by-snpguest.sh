#!/bin/bash
# GCP SEV-SNP Extended Remote Attestation using snpguest (Report Generation and Verification)
...
# Get Cert Chain ARK->ASK->VCEK from host's memory
echo "Get Cert Chain ARK->ASK->VCEK from host's memory"
